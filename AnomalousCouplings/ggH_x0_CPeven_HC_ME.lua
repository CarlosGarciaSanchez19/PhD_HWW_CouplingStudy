...
load_modules('/afs/cern.ch/user/c/cgarcias/workspace/private/Run3/mkShapesRDF/momemta/ggH_x0_CPeven_HC_ME/build/libme_ggH_HC_ME.so')
...
MatrixElement.ggH_HC = {
    pdf = "CT10nlo",
    pdf_scale = 125.,
    matrix_element = "ggH_HC_ME_HC_UFO_P1_Sigma_HC_UFO_gg_x0gg",
    matrix_element_parameters = {
        card = "/afs/cern.ch/user/c/cgarcias/workspace/private/Run3/mkShapesRDF/momemta/ggH_x0_CPeven_HC_ME/Cards/param_card.dat"
    },
